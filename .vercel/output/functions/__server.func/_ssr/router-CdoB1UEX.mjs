...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CdoB1UEX.js
...
var styles_default = "/assets/styles-BKv6fibp.css";
var APP_NAME = "SOVARA";
var Route$6 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Sovereign on-premise agentic AI workbench for confidential industrial work. Open-weight models, local tools, zero egress."
			},
			{
				name: "theme-color",
				content: "#08090a"
...
var rootRouteChildren = {
	...
	FleetRoute: Route$4.update({
		id: "/fleet",
		path: "/fleet",
		getParentRoute: () => Route$6
	}),
	ProofRoute: Route$3.update({
		id: "/proof",
		path: "/proof",
		getParentRoute: () => Route$6
	}),
